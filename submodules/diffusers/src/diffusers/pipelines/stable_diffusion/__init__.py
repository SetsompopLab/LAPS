...
try:
    ...
    _import_structure["pipeline_stable_diffusion_unconditional"] = ["StableDiffusionUnconditionalPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_unconditional import StableDiffusionUnconditionalPipeline
